    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 animate-[scaleUp_0.3s_ease-out] max-h-[80vh] overflow-y-auto">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8">
            <p className="text-gray-500">삭제할 재료가 없습니다.</p>
          </div>
        ) : (
        ...
        <div className="mt-6 pt-4 border-t border-gray-200">
          <button
            onClick={onClose}
            className="w-full px-4 py-3 bg-gray-200 hover:bg-gray-200 text-gray-700 font-semibold rounded-xl transition-colors"
          >
            닫기
          </button>
        </div>
